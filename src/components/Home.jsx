...
const Home = () => {
    return (
        <>
           <div className="flex flex-col md:flex-row items-center justify-center mt-25 gap-10 px-5 mb-70">
            <div className="flex justify-center">
                ...
                alt="Profile"
                className="w-64 h-64 rounded-full object-cover border-4 border-gray-600 shadow-2xl"
                style={{
            ...
            <div className="flex flex-col justify-center text-center md:text-left max-w-lg">
                <h1 className="text-5xl font-bold mb-4">Hi, I'm Anna Lavanya</h1>
                ...
                <div className="mt-5">
                    <a href="/AnnaLavanyaT- Resume.pdf" download="AnnaLavanya-Resume.pdf">
                        <button className="p-3 bg-emerald-500 rounded-2xl text-l text-black cursor-pointer hover:bg-emerald-800">Download Resume</button>
                    </a>
                </div>
            </div>
